...
const StatBlock: FC<{ stat: string; rolled: number }> = ({ stat, rolled }) => {
  ...
  return (
    <div className="relative flex-1">
      ...
      <div className="bg-stone-100 flex flex-col items-center border shadow-md p-4 rounded-lg">
        <h3 className="p-4 text-3xl font-bold">{calculateModifier(rolled)}</h3>
        <small className="uppercase">Strength {stat}</small>
      </div>
